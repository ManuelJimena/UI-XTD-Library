        ...
        <ButtonSizeContainer>
          ...
          <ButtonsGroup>
            ...
            <ButtonsRow>
              <Button
                bgColor="var(--red100)"
                hoverColor="var(--red30)"
                hoverTextColor="var(--red100)"
                width="99px"
                height="48px"
              >
                Button
          ...
          <ButtonsGroup>
            ...
            <ButtonsRow>
              <Button
                bgColor="var(--red30)"
                textColor="var(--red100)"
                hoverColor="var(--red100)"
                hoverTextColor="white"
                width="99px"
                height="48px"
              >
      ...
      {showSmallCode || (
        <ButtonSizeContainer>
          <ButtonsGroup>
            <GroupTitle>Primary</GroupTitle>
            <ButtonsRow>
              <Button textSize="14px" width="84px" height="36px">
                Button
              </Button>
              <Button textSize="14px" width="104px" height="36px">
                <i className="fas fa-check icon-check"></i>
